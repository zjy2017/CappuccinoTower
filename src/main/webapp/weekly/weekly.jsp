...
<div id="report_setting" style="margin-left: 260px;">
    ...
    <textarea id="tx1"
              style="resize: none;height:30px;width: 600px;border-radius:5px;background-color: #212121;color: #0ABD6A;border-color:#0ABD6A;"></textarea>
    ...
    <span id="team_add_span">
				<textarea placeholder="编辑周报新问题"
                          style="color: #0ABD6A;background-color: #212121;resize: none;width: 300px;height: 20px;"></textarea><br>
